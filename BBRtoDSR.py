...
if st.button("Print Results"):
    ...
    if len(allresults)>=2:
            ...
            ax7.plot(np.arange(1,89,1),6000/np.sin(np.radians(np.arange(1,89,1))),label='G*sinδ = 6000 kPa',linestyle='-.',marker='None',c='black',alpha=0.8)
            ...
            st.markdown("""---""")
            st.subheader(f"**Pavel-Kriz Phase Angle, [Detection of Phase Incompatible Binders](https://www.asphaltinstitute.org/engineering/specification-databases/changes-to-criterion-after-pav-aging/)**")
